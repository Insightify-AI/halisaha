...
--
-- Anamakine: localhost
-- Üretim Zamanı: 22 Kas 2025, 11:43:07
...
INSERT INTO `kullanicilar` (`kullanici_id`, `eposta`, `sifre`, `ad`, `soyad`, `telefon`, `rol`, `kayit_tarihi`, `toplam_puan`) VALUES
(1, 'admin@istun.edu.tr', '$2y$10$TKJaNJXp3ewqcB.qw.ZMB.oufPTx2ZrNLcoZvMbWPxCCfq.k1WSNe', 'Kemal', 'Serdaroğlu', '05001112233', 'admin', '2025-11-20 21:02:22', 0),
(2, 'sahip1@mail.com', '$2y$10$TKJaNJXp3ewqcB.qw.ZMB.oufPTx2ZrNLcoZvMbWPxCCfq.k1WSNe', 'Ahmet', 'Yılmaz', '05321112233', 'tesis_sahibi', '2025-11-20 21:02:22', 0),
(3, 'sahip2@mail.com', '$2y$10$TKJaNJXp3ewqcB.qw.ZMB.oufPTx2ZrNLcoZvMbWPxCCfq.k1WSNe', 'Mehmet', 'Demir', '05334445566', 'tesis_sahibi', '2025-11-20 21:02:22', 0),
(4, 'efe@mail.com', '$2y$10$TKJaNJXp3ewqcB.qw.ZMB.oufPTx2ZrNLcoZvMbWPxCCfq.k1WSNe', 'Murat Efe', 'Nalbant', '05410000001', 'musteri', '2025-11-20 21:02:22', 0),
(5, 'emin@mail.com', '$2y$10$TKJaNJXp3ewqcB.qw.ZMB.oufPTx2ZrNLcoZvMbWPxCCfq.k1WSNe', 'Muhammet Emin', 'Başar', '05410000002', 'musteri', '2025-11-20 21:02:22', 5),
(6, 'fatih@mail.com', '$2y$10$TKJaNJXp3ewqcB.qw.ZMB.oufPTx2ZrNLcoZvMbWPxCCfq.k1WSNe', 'Fatih', 'Korkmaz', '05410000003', 'musteri', '2025-11-20 21:02:22', 0),
(7, 'yusuf@mail.com', '$2y$10$TKJaNJXp3ewqcB.qw.ZMB.oufPTx2ZrNLcoZvMbWPxCCfq.k1WSNe', 'Yusuf', 'Dünya', '05410000004', 'musteri', '2025-11-20 21:02:22', 0),
(8, 'eren@mail.com', '$2y$10$TKJaNJXp3ewqcB.qw.ZMB.oufPTx2ZrNLcoZvMbWPxCCfq.k1WSNe', 'Eren', 'Kaçal', '05410000005', 'musteri', '2025-11-20 21:02:22', 0),
(9, 'ayse@mail.com', '$2y$10$TKJaNJXp3ewqcB.qw.ZMB.oufPTx2ZrNLcoZvMbWPxCCfq.k1WSNe', 'Ayşe', 'Yıldız', '05410000006', 'musteri', '2025-11-20 21:02:22', 0),
(10, 'fatma@mail.com', '$2y$10$TKJaNJXp3ewqcB.qw.ZMB.oufPTx2ZrNLcoZvMbWPxCCfq.k1WSNe', 'Fatma', 'Kara', '05410000007', 'musteri', '2025-11-20 21:02:22', 0),
(11, 'ali@mail.com', '$2y$10$TKJaNJXp3ewqcB.qw.ZMB.oufPTx2ZrNLcoZvMbWPxCCfq.k1WSNe', 'Ali', 'Veli', '05410000008', 'musteri', '2025-11-20 21:02:22', 0),
(12, 'burak@mail.com', '$2y$10$TKJaNJXp3ewqcB.qw.ZMB.oufPTx2ZrNLcoZvMbWPxCCfq.k1WSNe', 'Burak', 'Can', '05410000009', 'musteri', '2025-11-20 21:02:22', 0),
(13, 'cem@mail.com', '$2y$10$TKJaNJXp3ewqcB.qw.ZMB.oufPTx2ZrNLcoZvMbWPxCCfq.k1WSNe', 'Cem', 'Uzun', '05410000010', 'musteri', '2025-11-20 21:02:22', 0);
...
(4, 'gunluk', 'profil_duzenle', 'Profil Güncelle', 'Profil bilgilerini düzenle', 1, 20, 'fas fa-user-edit', 1, 4),
...
(1, 4, 0, 0, NULL, '2025-11-22 11:32:46'),
(2, 5, 0, 0, NULL, '2025-11-22 11:32:46'),
(3, 6, 0, 0, NULL, '2025-11-22 11:32:46'),
...
(1, 2, 1, 'Kadıköy Arena', 'Caferağa Mah. Moda Cad. No:1', '02163334455', NULL, 'https://images.unsplash.com/photo-1551958219-acbc608c6377?q=80&w=800&auto=format&fit=crop', 1, 2.5),
...
(22, 2, 7, 'Forum Bornova Yanı', 'Kazımdirik Mah. 372. Sokak', '02321110022', 'AVM yanı, alışveriş ve spor bir arada.', 'https://images.unsplash.com/photo-1551958219-acbc608c6377?q=80&w=800&auto=format&fit=crop', 1, 2.5),
...
(10, 6, 1, 2, 'GS-FB maçı daha stressiz geçerdi ', NULL, 'Onaylandı', '2025-11-22 12:09:11'),
...
--
ALTER TABLE `carkcevirmeler`
  MODIFY `cevrim_id` int NOT NULL AUTO_INCREMENT;

--
-- Tablo için AUTO_INCREMENT değeri `favoriler`
--
ALTER TABLE `favoriler`
  MODIFY `favori_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `kuponlar`
  MODIFY `kupon_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `puangecmisi`
  MODIFY `islem_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- Tablo için AUTO_INCREMENT değeri `questler`
--
ALTER TABLE `questler`
  MODIFY `quest_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `rozetler`
  MODIFY `rozet_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `streaktakibi`
  MODIFY `streak_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `yorumlar`
  MODIFY `yorum_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_haftalikpuanlar`  AS SELECT `k`.`kullanici_id` AS `kullanici_id`, `k`.`ad` AS `ad`, `k`.`soyad` AS `soyad`, `k`.`toplam_puan` AS `toplam_puan`, yearweek(`pg`.`tarih`,1) AS `hafta_numarasi`, sum(`pg`.`puan`) AS `haftalik_puan`, count(0) AS `aktivite_sayisi` FROM (`kullanicilar` `k` left join `puangecmisi` `pg` on((`k`.`kullanici_id` = `pg`.`kullanici_id`))) WHERE ((`k`.`rol` = 'musteri') AND (`pg`.`tarih` >= (curdate() - interval 7 day))) GROUP BY `k`.`kullanici_id`, `hafta_numarasi` ORDER BY `haftalik_puan` DESC ;
